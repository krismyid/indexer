...
import { BaseBuilder } from "@nftearth/sdk/dist/seaport-v1.2/builders/base";

import { redb } from "@/common/db";
import { toBuffer } from "@/common/utils";
import { config } from "@/config/index";
import * as utils from "@/orderbook/orders/seaport-v1.2/build/utils";
...
export const build = async (options: BuildOrderOptions) => {
  ...
  const builder: BaseBuilder = new Sdk.SeaportV12.Builders.SingleToken(config.chainId);
