...
import { Sudoswap } from "@nftearth/sdk";
...
export const tokenDeposit: EventData = {
  kind: "sudoswap",
  subKind: "sudoswap-token-deposit",
...
export const tokenWithdrawal: EventData = {
  kind: "sudoswap",
  subKind: "sudoswap-token-withdrawal",
...
export const spotPriceUpdate: EventData = {
  kind: "sudoswap",
  subKind: "sudoswap-spot-price-update",
