...
export const orderCancelled: EventData = {
  kind: "nftearth",
  subKind: "nftearth-order-cancelled",
  addresses: { [NFTEarth.Addresses.Exchange[config.chainId]?.toLowerCase()]: true },
...
export const counterIncremented: EventData = {
  kind: "nftearth",
  subKind: "nftearth-counter-incremented",
  addresses: { [NFTEarth.Addresses.Exchange[config.chainId]?.toLowerCase()]: true },
