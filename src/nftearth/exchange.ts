...
import * as CommonAddresses from "@reservoir0x/sdk/dist/common/addresses";
import { TxData, bn, generateSourceBytes, lc, n, s } from "@reservoir0x/sdk/dist/utils";
      ...
      : "0x" +
          keccak256(
            ...
            [
              ...
              "0xeaac5702377b8965e2d398fbf4db18a8dcb71133ee9ff60ab0d41c36d3c44703",
            ]
          ).slice(-40);
  }
